...
def set_size(width="aps_single", fraction=1, subplots=(1, 1), ratio=1 / 1.61803398875):
...
def figure_size(
    width="aps_single", fraction=1, subplots=(1, 1), ratio=1 / 1.61803398875
):
    """Return figsize and update font.size to match the target column width."""
    if isinstance(width, str) and width in _FONT_SIZES:
        matplotlib.rcParams["font.size"] = _FONT_SIZES[width]
    return set_size(width, fraction, subplots, ratio)
