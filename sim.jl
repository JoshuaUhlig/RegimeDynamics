...
function vdem_powerlaw_ctrw(T,alpha,x0,y0,res=1.0,alphax1=-0.717,alphax2=0.876,alphay1=-0.615,alphay2=0.961,cutoffxy1=10^(-6),cutoffx2=0.1,cutoffy2=0.1,cutoffx3=11.16444072945315,cutoffy3=5.525608279496182)
    """
    Simulates 2D CTRW 
    # Arguments
...
sim_ctrw_ens(ens_size,T,alpha,res,"sim_trajectories/")
